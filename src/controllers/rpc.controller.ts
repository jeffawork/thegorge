...
import { ValidationException, ResourceNotFoundException, AuthorizationException } from '../exceptions';
...
export class RpcController extends BaseController {
  ...
  async getRpcConfigs(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async getRpcConfig(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = this.getUserId(req);
  ...
  async createRpcConfig(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async updateRpcConfig(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  async deleteRpcConfig(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = this.getUserId(req);
      const rpcId = req.params.rpcId;
  ...
  async getRpcStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = this.getUserId(req);
      const rpcId = req.params.rpcId;
  ...
  async testRpcConnection(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const createRpcDto = plainToClass(CreateRpcDto, req.body);
      const validationErrors = await validate(createRpcDto);
  ...
  async getRpcMetrics(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = this.getUserId(req);
      const rpcId = req.params.rpcId;
  ...
  async toggleRpcStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = this.getUserId(req);
      const rpcId = req.params.rpcId;
